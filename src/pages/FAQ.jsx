...
const FAQ = () => {
    ...
    return (
        <Box className='w-full py-12 xl:py-32 mt-[88px] lg:mt-0'>
            <Box className='container mx-auto flex flex-col items-center'>
                <Box className='pb-8 lg:pb-16 flex flex-col items-center'>
                    <Typography variant='h1' fontWeight={700} className='pb-4 text-center'>Frequently Asked Questions</Typography>
                    <Typography variant='h4'>We're here to help you learn more.</Typography>
                </Box>
                <Box className='w-full flex flex-col items-start px-8 py-8 lg:px-48 lg:py-24' backgroundColor={colors.primary[400]}>
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>What services does TrendLeaders offer?</Typography>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>How can I contact TrendLeaders?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>What is the process for starting a project with TrendLeaders?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>What sets TrendLeaders apart from other consulting firms?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>Do you offer services internationally?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>What types of companies can benefit from TrendLeaders' services?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>How does TrendLeaders ensure the quality of its services?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>Does TrendLeaders offer training or workshops?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>What is TrendLeaders' mission?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>Where are TrendLeaders' offices located?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>How can I stay updated with TrendLeaders' news and updates?</Typography>
                    <Typography variant='h4' className='pb-16'>
                    ...
                    <Typography variant='h2' fontWeight={500} className='px-8 pb-4'>Does TrendLeaders have corporate social responsibility (CSR) programs?</Typography>
